...
class MetaMultipleChoiceOptionView: RoundedView {
    ...
    private func addBorderLayer() {
        ...
        borderLayer.lineWidth = MetaMultipleChoiceOptionTableViewCell.ViewLayoutConstants.optionViewBorderLayerLineWidth
        borderLayer.strokeColor = MetaMultipleChoiceOptionTableViewCell.ViewLayoutConstants.optionViewBorderLayerStrokeColor.cgColor
