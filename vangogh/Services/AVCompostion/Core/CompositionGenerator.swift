...
public class CompositionGenerator {
    ...
    public var timeline: Timeline {
        didSet {
            needsRebuildComposition = true
            needsRebuildVideoComposition = true
            needsRebuildAudioMix = true
        }
    }
    ...
    private var needsRebuildComposition: Bool = true
    private var needsRebuildVideoComposition: Bool = true
    private var needsRebuildAudioMix: Bool = true
    ...
    public func buildExportSession(sceneUUID: String, rootDirectoryURL: URL, presetName: String) -> AVAssetExportSession? {
        ...
        exportSession?.outputURL = {
            let filename = /* ProcessInfo.processInfo.globallyUniqueString */ sceneUUID + ".mp4"
    ...
    public func buildComposition() -> AVComposition {
        ...
        if let composition = self.composition, !needsRebuildComposition {
            return composition
        }
        ...
        self.needsRebuildComposition = false
    ...
    public func buildVideoComposition() -> AVVideoComposition? {
        ...
        if let videoComposition = self.videoComposition, !needsRebuildVideoComposition {
        ...
        self.needsRebuildVideoComposition = false
    ...
    public func buildAudioMix() -> AVAudioMix? {
        ...
        if let audioMix = self.audioMix, !needsRebuildAudioMix {
            return audioMix
        }
        ...
        self.needsRebuildAudioMix = false
