...
class MetaVote: MetaNode {
    ...
    init(index: Int, uuid: String = UUID().uuidString.lowercased(), nodeType: MetaNodeType = .vote, startTimeMilliseconds: Int64 = 0, durationMilliseconds: Int64 = GlobalValueConstants.defaultNodeItemDurationMilliseconds, question: String = MetaNodeValueConstants.defaultVoteQuestion, options: [String] = MetaNodeValueConstants.defaultVoteOptions, nodeAlignment: MetaNodeAlignment = .bottomRight, backgroundColorCode: [Decimal] = MetaNodeValueConstants.defaultNodeBackgroundColorCode) {
